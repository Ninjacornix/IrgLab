...
int main()
{
    ...
    //string location = "/Users/ninjacornix/irglab/irgLab/vjezba8a/resources/glava/glava.obj";
    string location = "/Users/ninjacornix/irglab/irgLab/vjezba8a/resources/sus_rotated.obj";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        s.setVec3("light.position", l.getLightPos());
