...
public:
    Render(vector<Object> objects){
        ...
        string vertexSource = "/Users/ninjacornix/irglab/irgLab/vjezba5a/shaders/shader.vert";
        string fragmentSource = "/Users/ninjacornix/irglab/irgLab/vjezba5a/shaders/shader.frag";
