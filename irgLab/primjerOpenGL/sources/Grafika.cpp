...
int Grafika::loadRasterShader(char* path)
{
	...
	pathVert.append("/Users/ninjacornix/irglab/irgLab/primjerOpenGL/shaders/shader3.vert");
	pathFrag.append("/Users/ninjacornix/irglab/irgLab/primjerOpenGL/shaders/shader3.frag");
...
int Grafika::osvijetliFragment(int x, int y, glm::vec3 boja){
	if (x >= 0 && x < width || y >= 0 && y < height) {
		...
		std::cerr << "ERROR: poku�aj osvjetljavanja izvan podrucja";
		return -1;
	}
}
